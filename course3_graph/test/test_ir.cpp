...
TEST(test_ir, pnnx_graph_ops) {
  ...
  std::string  param_path
      = "course3_graph/model_file/test_linear.pnnx.param";
  std::string bin_path("course3_graph/model_file/test_linear.pnnx.bin");
  std::unique_ptr<pnnx::Graph> graph;
  graph = std::make_unique<pnnx::Graph>();
...
TEST(test_ir, pnnx_graph_operands) {
   ...
   */
  std::string bin_path("course3_graph/model_file/test_linear.pnnx.bin");
  std::string param_path("course3_graph/model_file/test_linear.pnnx.param");
