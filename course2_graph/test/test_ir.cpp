...
TEST(test_ir, pnnx_graph_ops) {
  ...
  std::string  param_path
      = "course2_graph/model_file/test_linear.pnnx.param";
  std::string bin_path("course2_graph/model_file/test_linear.pnnx.bin");
...
TEST(test_ir, pnnx_graph_operands) {
   ...
   */
  std::string bin_path("course2_graph/model_file/test_linear.pnnx.bin");
  std::string param_path("course2_graph/model_file/test_linear.pnnx.param");
